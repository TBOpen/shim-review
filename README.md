...
NV doesn't seem to have a direct link - you have to search:

https://www.nvsilverflume.gov/redirectToCenuity/be
Search for Entity: C27039-2001
...
*******************************************************************************
Because they don't meet our needs and requirements for our product.
...
*******************************************************************************
No Change Since Last Verification:
...
*******************************************************************************
Removes the unneeded x64 on x32 section which prevents the x32 on x64 (not using this build) from working.  (explained in patch)
Option to disable fallback as we don't want or need it, 
Option to disable Load Options (not just removable drives) as we don't want or need it.
...
*******************************************************************************
Yes, using grub2-unsigned-2.14-2ubuntu1 from Ubuntu 26.04.
...
*******************************************************************************
No, there is no need to provide old shim hashes to MS - no issues in our boot chain - would prevent recovery boot disks with backup images from booting.
...
*******************************************************************************
Yes, using 6.17.x already has all patches applied. 
...
*******************************************************************************
Using new certificate each time.
...
*******************************************************************************
The "terabyte_shim-16.1_built" directory will contain the build log as well.
...
shim.terabyte,1,TeraByte,UEFI shim,3,https://www.terabyteunlimited.com
...
grub.terabyte,1,TeraByte,grub2,2.14-tbu-2026-1,https://www.terabyteunlimited.com/
```
...
lzopio crypto boot all_video efi_gop video_bochs video_cirrus video_fb 
video help peimage
...
*******************************************************************************
will be using grub2-unsigned-2.14-2ubuntu1 from Ubuntu 26.04.
...
*******************************************************************************
Haven't done much with reviewing process, have provided patches / fixes for shim in the past.
